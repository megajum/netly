...
<div class="panes">
	...
	<input type="hidden" value="<?php   echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<div id="field-camp_type-container" class="field f_100" style="margin-top:10px" >
          ...
          <div  id="field111-container" class="field typepart Articles ArticlesBase Amazon Clickbank Youtube Vimeo Flicker  eBay f_100 Pinterest Instagram Twitter SoundCloud Itunes Envato DailyMotion Walmart Careerjet" style="display:none;" >
               <label for="field111">
		  ...
		  <label>Posts from</label>
	         ...
	         <div class="option clearfix">
	          ...
	          <div class="option clearfix">
			        ...
			        <input data-controls="OPT_FB_LANG_c" name="camp_options[]" value="OPT_OPT_FB_LANG" type="checkbox">
			        <span class="option-title">
							Set localization language
			        </span>
			        <br>
			        
			        <div id="OPT_FB_LANG_c" class="field f_100">
			        	
			        	<label>Language Code</label> <input value="<?php  echo @$camp_general['cg_fb_lang']   ?>" name="cg_fb_lang" type="text">
			        	<div class="description" >Two letter language code ( e.g. FR)</div>
	          ...
	          <div class="option clearfix">
	                    ...
	                    <span class="option-title">
								When posting from a profile, only post profile owner posts 
	                    </span>
	                    <br>
	          </div>
